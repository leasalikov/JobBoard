        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <article className="flex max-w-xl flex-col items-start justify-between">
                ...
                <div className="group relative">
                    ...
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">geographical Location:{props.geographicalLocation}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">required Experience Level:{props.requiredExperienceLevel}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">salary Offered:{props.salaryOffered}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">job Type:{props.jobType}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">field:{props.field}</p>
                    {/* <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">jobTitle:{props.jobTitle}</p> */}
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">requirements:{props.requirements}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">job Description:{props.jobDescription}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">status:{props.status}</p>
                </div>
