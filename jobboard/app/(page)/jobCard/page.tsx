        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <article className="flex max-w-xl flex-col items-start justify-between">
                ...
                <div className="group relative">
                    ...
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">geographical Location:{job.geographicalLocation}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">required Experience Level:{job.requiredExperienceLevel}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">salary Offered:{job.salaryOffered}</p>
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">job Type:{job.jobType}</p>
                    ...
                    <p className="mt-5 line-clamp-3 text-sm leading-6 text-gray-600">requirements:{job.requirements}</p>
                ...
                {isCandidates && <Candidates  jobId={job.jobId}/>}
